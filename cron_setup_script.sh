...
SCRIPT_PATH="/home/admin/aos_restart.py"
...
0 8 * 11-12,1-3 * /usr/bin/python3 /home/admin/aos_restart.py -y --password "REPLACE_PASSWORD" >> /var/log/aos_restart_cron.log 2>&1

# AOS Service Restart - Midnight PDT (UTC-7) = 7:00 AM UTC  
# Runs during Pacific Daylight Time (roughly Mar-Nov)
0 7 * 3-10 * /usr/bin/python3 /home/admin/aos_restart.py -y --password "REPLACE_PASSWORD" >> /var/log/aos_restart_cron.log 2>&1
EOF
